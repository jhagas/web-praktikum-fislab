...
export function AvatarChange() {
  ...
  return (
    <>
      <input type="checkbox" id="ppChange" className="modal-toggle" />
      <div className="modal">
        <div className="modal-box">
          <h3 className="font-bold text-lg mb-2">Ganti Foto Profil</h3>
          <input
            ref={file}
            type="file"
            onChange={onFileChange}
            accept="image/*"
            className="file-input w-full file-input-sm file mb-4"
          />
          {imageSrc && (
